...
// Objects representing basic types. 
// All variables will be of one of these types or a derived type from one of them. 
// Note that (typename){initializer} is C99 feature to write struct literals.
